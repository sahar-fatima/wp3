...
function getStyle(type) {
    ...
    */
    ...
    if (type == "text") {
        ...
        html.find("#field_position_" + no).html('<img align="left" src="' + piereg_wp_pie_register_url + '/assets/images/honeypot.png"><input type="text" disabled="disabled"  id="field_' + no + '" class="input_fields">');
    ...
    if (type == "pagebreak") {
        ...
        html.find("#field_position_" + no).html('<img id="captcha_img" src="' + piereg_wp_pie_register_url + '/assets/images/new-recatpcha.png" data-captcha-img-src="' + piereg_wp_pie_register_url + '/assets/images/" /><p><strong>Note:</strong> Please make sure that Re-captcha keys are entered in Settings page</p>');
        ...
        html.find("#field_position_" + no).html('<img src="' + piereg_wp_pie_register_url + '/assets/images/plus.png" /><input type="text" id="field_' + no + '" class="input_fields" disabled="disabled">');
...
function bindButtons() {
    ...
    piereg(".delete_btn").live("click", function() {
        ...
        piereg(this).parents("li").fadeOut(function() {
            ...
            if (delType == "default" || delType == "name" || delType == "address" || delType == "captcha" || delType == "math_captcha" || delType == "two_way_login_phone" || delType == "invitation" || delType == "terms" || delType == "pricing" || delType == "username" || delType == "honeypot" || delType == "profile_pic") {
...
piereg(document).ready(function() {
    ...
    piereg("#elements").droppable({
        ...
        drop: function(event, ui) {
            ...
            if (endHtml) {
                ...
                if (dragType == "invitation" || dragType == "terms" || dragType == "name" || dragType == "address1" || dragType == "captcha" || dragType == "math_captcha" || dragType == "two_way_login_phone" || dragType == "aim" || dragType == "yim" || dragType == "jabber" || dragType == "description" || dragType == "url" || dragType == "pricing" || dragType == "username" || dragType == "honeypot" || dragType == "profile_pic") {
    ...
    if (piereg('.pieregister-admin .invitation').length > 0) {
        ...
        piereg(".expiry_datepicker_update").datepicker({
            changeMonth: true,
            numberOfMonths: 1,
            minDate: dateToday,
            dateFormat: 'yy-mm-dd',

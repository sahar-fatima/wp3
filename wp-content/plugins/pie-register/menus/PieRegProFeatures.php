...
<div id="container"  class="pieregister-admin">
    <div class="right_section">
        <div class="go-pro">
            ...
            <div class="features-main-container">
                <div class="et_pb_row et_pb_row_1 features-row">
                    <div class="feature-single-container margin-right">
                        <div class="feature-icon-container"><img src="<?php echo plugins_url() ?>/pie-register/assets/images/img-info3.png" /></div>
                    ...
                    <div class="feature-single-container margin-right">
                        <div class="feature-icon-container"><img src="<?php echo plugins_url() ?>/pie-register/assets/images/img-info1.png" /></div>
                        <div class="feature-content-container">
                    ...
                    <div class="feature-single-container margin-right">
                        <div class="feature-icon-container"><img src="<?php echo plugins_url() ?>/pie-register/assets/images/img-info2.png" /></div>
                        <div class="feature-content-container">
            ...
            <a href="https://pieregister.com/plan-and-pricing/?utm_source=plugin-dashboard&utm_medium=goprodashboard&utm_campaign=go_pro_admin&utm_content=addons"><?php _e("View Pricing","pie-register") ?></a>
        </div>
			...
			<?php  } else { ?> 
                ...
                <div class="features-main-container">
                    <div class="et_pb_row et_pb_row_1 features-row">
                        ...
                        <div class="feature-single-container margin-right">
                            <div class="feature-icon-container" style="background-image: url(<?php echo plugins_url("assets/images/pro/feature-10.png", dirname(__FILE__) ); ?>)"></div>
                            <a class="" href="">
                                <div class="feature-content-container">
                                    <h5>Block Users</h5>
                        ...
                        <div class="feature-single-container margin-right">
                            <div class="feature-icon-container" style="background-image: url(<?php echo plugins_url("assets/images/pro/feature-15.png", dirname(__FILE__) ); ?>)"></div>
                            <a class="" href="">
                                <div class="feature-content-container">
                        ...
                        <div class="feature-single-container margin-right">
                            <div class="feature-icon-container" style="background-image: url(<?php echo plugins_url("assets/images/pro/feature-18.png", dirname(__FILE__) ); ?>)"></div>
                            <a class="" href="">
                                <div class="feature-content-container">
                                    <h5>Auto Login</h5>
                        ...
                        <div class="feature-single-container margin-right">
                            <div class="feature-icon-container" style="background-image: url(<?php echo plugins_url("assets/images/pro/feature-16.png", dirname(__FILE__) ); ?>)"></div>
                            <a class="" href="">
                                <div class="feature-content-container">
                        ...
                        <div class="feature-single-container margin-right">
                            <div class="feature-icon-container" style="background-image: url(<?php echo plugins_url("assets/images/pro/feature-9.png", dirname(__FILE__) ); ?>)"></div>
                            <a class="" href="">
                                <div class="feature-content-container">
                        ...
                        <div class="feature-single-container margin-right">
                            <div class="feature-icon-container" style="background-image: url(<?php echo plugins_url("assets/images/pro/3.png", dirname(__FILE__) ); ?>)"></div>
                            <a class="" href="">
                                <div class="feature-content-container">
                        ...
                        <div class="feature-single-container margin-right">
                            <div class="feature-icon-container" style="background-image: url(<?php echo plugins_url("assets/images/pro/feature-19.png", dirname(__FILE__) ); ?>)"></div>
                            <a class="" href="">
                                <div class="feature-content-container">
                        ...
                        <div class="feature-single-container margin-right">
                            <div class="feature-icon-container" style="background-image: url(<?php echo plugins_url("assets/images/pro/feature-12.png", dirname(__FILE__) ); ?>)"></div>
                            <a class="" href="">
                                <div class="feature-content-container">
                        ...
                        <div class="feature-single-container margin-right">
                            <div class="feature-icon-container" style="background-image: url(<?php echo plugins_url("assets/images/pro/feature-6.png", dirname(__FILE__) ); ?>)"></div>
                            <a class="" href="">
                                <div class="feature-content-container">
                        ...
                        <div class="feature-single-container margin-right">
                            <div class="feature-icon-container" style="background-image: url(<?php echo plugins_url("assets/images/pro/feature-13.png", dirname(__FILE__) ); ?>)"></div>
                            <a class="" href="">
                                <div class="feature-content-container">
                                    <h5>Ticket Based Support</h5>

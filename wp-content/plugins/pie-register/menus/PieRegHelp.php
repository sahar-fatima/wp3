        ...
        <div class="pie-help-left">
            ...
            <div class="wrapper-forms">
                <?php if($action == "documentation" || $action == ""){ ?>
                    ...
                    <br /><br />
                    <?php _e("If you still have any query, feel free to contact us by submitting a support ticket form on the right","pie-register"); ?></p>
                    <div class="pieHelpMenuButtonContaner">
                        <ul class="pieHelpMenuButton">
                            <li><a href="http://pieregister.com/faqs/" target="_blank_pieHelp_1"><?php _e("Browse Frequently Asked Questions","pie-register"); ?></a></li>
                            <li><a href="http://pieregister.com/forums/forum/pie-register-3-0-support/" target="_blank_pieHelp_2"><?php _e("Pie Register v3.0 and above Problems","pie-register"); ?></a></li>
                            <li><a href="http://pieregister.com/forum/" target="_blank_pieHelp_3"><?php _e("Go To Forums","pie-register"); ?></a></li>
                            <li><a href="https://pieregister.com/manual/introduction/" target="_blank_pieHelp_4"><?php _e("Pie Register Manual","pie-register"); ?></a></li>
                            <li><a href="https://pieregister.com/manual/lets-get-started/" target="_blank_pieHelp_5"><?php _e("Getting Started","pie-register"); ?></a></li>
                            <li><a href="https://pieregister.com/manual/community-vs-pro-version/" target="_blank_pieHelp_6"><?php _e("Community v/s PRO version","pie-register"); ?></a>
                            </li>
                            <li><a href="https://pieregister.com/forums/forum/installation-problems/" target="_blank_pieHelp_7"><?php _e("Installation Problems","pie-register"); ?></a></li>
                            <li><a href="https://pieregister.com/manual/pie-register-features/" target="_blank_pieHelp_8"><?php _e("Pie Register Features","pie-register"); ?></a></li>
                            <li><a href="http://pieregister.com/forums/forum/news-announcements/" target="_blank_pieHelp_9"><?php _e("News and Announcements","pie-register"); ?></a></li>
                            <li><a href="https://wordpress.org/support/plugin/pie-register/reviews/?filter=5" target="_blank_pieHelp_9"><?php _e("Enjoying Pie Register ? Give us a rating.","pie-register"); ?>!</a></li>
                        </ul>
                    </div>
                <?php }elseif($action == "shortcodes"){ ?>
                    <p class="pieHelpPara">
                <?php _e("Pie Register allows you to easily embed Login, Registration, Forgot Password and Profile pages anywhere using Shortcodes. You can embed these pages inside a post, page, custom post type or even in a widgets by using the following Shortcodes","pie-register"); ?></p>
                ...
                <?php
                    ...
                    if(PIEREG_IS_ACTIVE){
                        ...
                        ?>
                        <form method="post" action="" id="piereg_form_general_settings_page" onsubmit="return piereg_deactivate_keys_Form(this);">
                        <?php if( function_exists( 'wp_nonce_field' )) wp_nonce_field( 'piereg_wp_deactivate_plugin_license_nonce','piereg_deactivate_plugin_license_nonce'); ?>    
                            <div class="fields">
                                <label for="custom_logo_title"><?php _e( 'License Key', 'pie-register' ); ?></label>
                                <input type="text" class="input_fields" value="<?php echo $LK_options['api_key'];?>" disabled="disabled" readonly="readonly" />
                                <span class="piereg_license_key_icon_span"><img class="piereg_license_key_icon" title="" src="<?php echo plugins_url("assets/images/complete.png", dirname(__FILE__) ); ?>"></span>
                            </div>
                            
                            <div class="fields">
                                <label for="custom_logo_title"><?php _e( 'Email Address', 'pie-register' ); ?></label>
                            ...
                            <div class="fields fields2">
                                ...
                                <input type="submit" class="submit_btn" name="submit_btn" value="<?php _e("Deactivate","pie-register");?> " />
                            <p><?php _e("Deactivate this license to use on another site",'pie-register') ?>.</p>
                            </div>
                        </form>                
                <?php
                    }else{ 
                ...
                <?php }elseif($action == "version" && $subaction == "" || $action == "version" && $subaction == "environment"){ ?>
                        ...
                        else
                        {
                            ...
                            echo '<span class="quotation">'.__("Sorry, Pie Register requires PHP 5.0 or higher. Please deactivate Pie Register","pie-register").'</span>';
                        }
                        ?>
                        </div>
                        <div class="fields">
                        ...
                        <?php
                            ...
                            else
                            {
                                ...
                                echo '<span class="quotation">'.__("Sorry, Pie Register requires MySQL 5.0 or higher. Please deactivate Pie Register","pie-register").'</span>';
                            }
                            ?>
                        ...
                        else
                        {
                            ...
                            echo '<span class="quotation">'.__("Sorry, Pie Register requires Wordpress 3.5 or higher. Please deactivate Pie Register","pie-register").'</span>';
                        }
                        ?>
                        </div>
                        <div class="fields">
                        ...
                        else
                        {
                            ...
                            echo '<span class="quotation">'.__("Please install CURL on server","pie-register").'</span>';
                        }
                        ?>
                        </div>
                        <div class="fields">
                        ...
                        {
                            echo '<span class="installation_status_faild">'.__("Disable","pie-register").'</span>';
                            echo '<span class="quotation">'.__("Please install File Get Contents on server","pie-register").'</span>';
                        }
                        ?>
                        </div>
                        <div class="fields">
                        ...
                        <?php } else {?>
                                <div class="fields">
                                    ...
                                    echo '<span class="installation_status_faild">'.__("Disable","pie-register").'</span>';
                                    echo '<span class="quotation">'.__("Please install ini_get on server","pie-register").'</span>';
                                ?>
                                </div>
                        <?php } ?>
                        <div class="fields">

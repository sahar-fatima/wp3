        ...
        <div class="fields">
          <form method="post" action="" enctype="multipart/form-data">
            ...
            <div class="file_container">
              ...
              <?php _e("Supports JSON and CSV format. Importing data will remove all your existing invitation codes","pie-register"); ?>
              </span>             
              <span class="quotation"><?php echo sprintf( __( 'You may want to see', 'pie-register').' <a target="_blank" download href="%s"> '.__('the example of the CSV file', 'pie-register').'</a>.' , plugin_dir_url(__FILE__).'examples/example-invitaion-codes.csv'); ?></span>
            </div>
          </form>
        </div>
      </fieldset>
            ...
            <li>
              <div class="fields date">
                ...
                <div class="start_date">
                  ...
                  <img id="start_icon" src="<?php echo plugins_url('pie-register'); ?>/assets/images/calendar_img.jpg" width="22" height="22" alt="calendar" class="calendar_img" /> </div>
                <div class="end_date">
                  <label for="field_">
                    <?php _e("End","pie-register"); ?>
                  </label>
                  <input id="date_end" name="date_end" type="text" class="input_fields date_start" />
                  <img id="end_icon" src="<?php echo plugins_url('pie-register'); ?>/assets/images/calendar.png" width="22" height="22" alt="calendar" class="calendar_img" /> </div>

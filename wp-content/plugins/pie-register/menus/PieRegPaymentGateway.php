          ...
          <div class="right_section">
            <div class="settings">
              ...
              <div id="pie-register">
                ...
                <div class="fields">
                <p><strong>
                  <?php _e('Please follow the steps below to create and set the required Options.', 'pie-register');?>
                  </strong></p>
                <ol>
                ...
                <li><?php _e("Give Your Button a Name. i.e: Website Access fee and Set Price.","pie-register"); ?></li>

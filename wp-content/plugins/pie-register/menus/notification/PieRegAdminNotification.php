                ...
                <div class="notifications">
                  <form method="post" action="#piereg_admin_notification">
                    ...
                    <ul>
                      ...
                      <li>
                        <div class="fields">
                        <label style="font-size:12px;margin-bottom:10px;font-size:14px;"><i><?php _e("Message: Enter a message below to receive a notification email when new users register.",'pie-register');?></i></label>
                        <p>

  ...
  <div class="right_section">
    <div class="invitation settings">
     ...
     if(isset($this->pie_post_array['notice']) && !empty($this->pie_post_array['notice']) ){
      echo '<div id="message" class="updated fade msg_belowheading ext-space"><p><strong>' . $this->pie_post_array['notice'] . '.</strong></p></div>';
     }  
  ...
  <?php if(!isset($_GET['inviteemail'])){ ?>
    <div style="clear:both;float:left;padding-right:5px;margin-right:5px;">
        <form method="post" id="form_invitation_code_per_page_items">
          ...
          <select name="invitation_code_per_page_items" id="invitation_code_per_page_items" title="<?php _e("Select Per Page Invitation code","pie-register"); ?>">
            <?php
      ...
      <div style="float:left;">
        ...
        <span style="color:#F00;display:none;" id="invitaion_code_error"><?php _e("Select Bulk Option and also Invitation Code","pie-register");?></span>
      </div>

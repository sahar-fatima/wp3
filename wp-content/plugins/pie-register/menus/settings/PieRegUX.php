...
<?php if( (isset($_GET['tab']) && $_GET['tab'] == 'ux') && (isset($_GET['subtab']) && $_GET['subtab'] == 'advanced')) { ?>
        <?php 	$_disable = "";
			if(!$this->piereg_pro_is_activate)	{
				$_disable 			= "disabled";
				$_available_in_pro 	= ' - <span style="color:red;font-size:14px;">'. __("Available in Pro version","pie-register") . '</span>';
			}
			?>
...
<?php } else { ?>	
    ...
    <div class="fields">
        ...
        <label class="label_mar_top" for="display_hints">
			<?php _e("Show tips and hints on form editor tool.",'pie-register') ?>
        </label>        
    </div>

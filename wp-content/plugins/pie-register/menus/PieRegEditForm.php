...
<div style="width:99%;overflow:hidden;" class="pieregister-admin">
  <div class="right_section">
    <div class="pie_wrap">
      ...
      <?php
       	if( isset($this->pie_post_array['error_message']) && !empty( $this->pie_post_array['error_message'] ) )
            echo '<div id="error" class="error fade msg_belowheading"><p><strong>' . $this->pie_post_array['error_message']  . "</strong></p></div>";
			
       	if(isset( $this->pie_post_array['success_message'] ) && !empty( $this->pie_post_array['success_message'] ))
            echo '<div id="message" class="updated fade msg_belowheading"><p><strong>' . $this->pie_post_array['success_message']  . "</strong></p></div>";
      ...
      <form method="post" id="formeditor">
            ...
            <div class="fields_main">
              <div class="advance_options_fields">
				...
				$notification = array(__("Admin Verification","pie-register"),
									  ...
									  __("E-mail & Admin Verification","pie-register"));
			  	?>
                <div class="advance_fields">
                  <label>
                ...
                <div class="enabel_conditional_logic_area">
                  <div class="advance_fields">
                    <label>
                      <?php _e("Enable Conditional Logic","pie-register"); ?>
                    </label>
					...
					foreach($data['form']['notification'] as $form_notf_key=>$form_notf_val){ ?>
                      <div class="advance_fields">
                        <label for="form_notification">
                          <?php _e("Verifications","pie-register"); ?>
                        </label>
                        ...
                        <?php _e("this field if","pie-register");?>
                        </span>
                        ...
                        <select id="form_field_rule_operator" name="field[form][field_rule_operator][]" class="field_rule_operator_select" style="width:auto;">
                          ...
                          <?php _e("equal","pie-register"); ?>
                          </option>
                          <option value="!=" <?php echo ((isset($data['form']['field_rule_operator'][$form_notf_key]) && $data['form']['field_rule_operator'][$form_notf_key] == "!=")?'selected="selected"':"");?>>
                          <?php _e("not equal","pie-register"); ?>
                          </option>
                          ...
                          <?php _e("not empty","pie-register"); ?>
                          </option>
                          <option value=">" <?php echo ((isset($data['form']['field_rule_operator'][$form_notf_key]) && $data['form']['field_rule_operator'][$form_notf_key] == "&gt;")?'selected="selected"':"");?>>
                          <?php _e("greater than","pie-register"); ?>
                          </option>
                          <option value="<" <?php echo ((isset($data['form']['field_rule_operator'][$form_notf_key]) && $data['form']['field_rule_operator'][$form_notf_key] == "&lt;")?'selected="selected"':"");?>>
                          <?php _e("less than","pie-register"); ?>
                          </option>
                          ...
                          <?php _e("starts with","pie-register"); ?>
                          </option>
        ...
        <!--Form Settings End-->
        <fieldset>
          <legend align="center"><?php echo _e("Drag Fields Here","pie-register"); ?></legend>
          <div id="hint_1" class="fields_hint" style="left: 95%;top: 50%; z-index:2;"> <img src="<?php echo plugins_url('pie-register'); ?>/assets/images/left_arrow.jpg" width="45" height="26" align="left">
            <div class="hint_content">
              ...
              <input type="button" class="thanks" value="<?php _e("Yes Thanks !","pie-register"); ?>">
            </div>
          </div>
          <!--Form Fields-->
    ...
    <div class="right_menu">
      <div id="hint_0" style="top: 135px;margin-left: -271px;position: fixed;float:right;" class="fields_hint"> <img src="<?php echo plugins_url('pie-register'); ?>/assets/images/right_arrow.jpg" width="45" height="26" align="right">
        <div class="hint_content">
          <h4>
            <?php _e("Did You Know ?","pie-register"); ?>
          </h4>
          <span>
          <?php _e("You can Drag n Drop fields.","pie-register"); ?>
          </span> <br>
          <input type="button" class="thanks" value="<?php _e("Yes Thanks !","pie-register"); ?>">
        </div>
      </div>
